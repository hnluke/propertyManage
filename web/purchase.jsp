...
<body>
<form id="submitForm" name="submitForm" action="${pageContext.request.contextPath}/PurchaseServlet?purchase=in" method="post">
...
<%--                        <input type="button" value="" class="ui_input_btn01" id="addBtn" />--%>
<%--                        <input type="button" value="删除" class="ui_input_btn01" onclick="batchDel();" />--%>
                        <span id="showTxt2">${flag}</span>
                        <input type="button" value="导入采购单" class="ui_input_btn01" id="importBtn2"
                               onclick = "location.href='${pageContext.request.contextPath}/PurchaseServlet?purchase=im'"/>
<%--                               onclick = "location.href='${pageContext.request.contextPath}/PurchaseServlet?purchase=im'"/>--%>
                        <input type="submit" value="资产入库" class="ui_input_btn01"/>
                        <input type="button" value="导出" class="ui_input_btn01"
                               onclick="location.href='${pageContext.request.contextPath}/PurchaseServlet?purchase=ex'" />
                    </div>
                </div>
            </div>
        </div>
...
<%--                        <th>操作</th>--%>
                    ...
                    <tr>
                        <td><input type="checkbox" name="IDCheck" value="${pur.p_id}" class="acb" onclick = "selected();"/></td>
                        <td>${pur.p_code}</td>
                        <td>${pur.p_assname}</td>
                        <td>${pur.p_type}</td>
                        <td>${pur.p_model}</td>
